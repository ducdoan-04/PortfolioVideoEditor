            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="mt-8 z-10">
                <div className="bg-white rounded-2xl px-8 py-4 shadow-lg flex gap-6 items-center">
                  ...
                  <a href="https://id.zalo.me/0919261712" className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center hover:scale-105 transition-colors" aria-label="Zalo">
